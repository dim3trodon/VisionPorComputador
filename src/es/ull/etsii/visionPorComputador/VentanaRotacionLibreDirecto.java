...
public class VentanaRotacionLibreDirecto extends JFrame {
  ...
  public VentanaRotacionLibreDirecto(Imagen imagen, Interfaz interfazRef) {
    ...
    getBotonOk().addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent arg0) {
        ...
        Imagen imagenGrados = new Imagen(getImagen().turn_direct(
